...
import ar.org.ineco.prl.ninios.util.DragNDrop.LongClickListener;
import ar.org.ineco.prl.ninios.util.Utils;
import ar.org.ineco.prl.ninios.util.VerdanaButton;
import ar.org.ineco.prl.ninios.util.VerdanaTextView;

public class ComprensionActivity extends BaseActivity {
    ...
    public void drawUI () {
        ...
        if (currentQuestion != null) {
            ...
            Log.d(ComprensionActivity.class.getName(), "PregId: " + currentQuestion.getId());
    ...
    public void onPause () {
        ...
        Log.d(ComprensionActivity.class.getName(), "Loader Closed, FeedbackDialogs Dismissed.");
    }
}
