...
public class MyDatabase extends SQLiteAssetHelper {
    ...
    public static final String OPTION_COLUMN_ID = "opc_id";
    ...
    public static final String QUESTION_COLUMN_ID = "preg_id";
    ...
    public static final String QUESTION_COLUMN_QID = "preg_padre_id";
    public static final String QUESTION_COLUMN_LVLID = "niv_id";

    public static final String TABLE_PREGIMG = "preg_img";
    public static final String PREGIMG_COLUMN_ID = "pregimg_id";
    ...
    public static final String REGUSE_COLUMN_ID = "ru_id";
    ...
    public static final String SND_COLUMN_ID = "snd_id";
    public static final String SND_COLUMN_NAME = "snd_nombre";

    public static final String TABLE_MODULE = "modulo";
    public static final String MODULE_COLUMN_ID = "mod_id";
    public static final String MODULE_COLUMN_NAME = "mod_nombre";
